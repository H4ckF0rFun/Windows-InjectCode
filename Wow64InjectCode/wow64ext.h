...
extern "C"
{
	__declspec(dllexport)DWORD64 __cdecl X64Call(DWORD64 func, int argC, ...);
	__declspec(dllexport)DWORD64 __cdecl GetModuleHandle64(const wchar_t* lpModuleName);
	__declspec(dllexport)DWORD64 __cdecl GetProcAddress64(DWORD64 hModule, const char* funcName);
	__declspec(dllexport)SIZE_T __cdecl VirtualQueryEx64(HANDLE hProcess, DWORD64 lpAddress, MEMORY_BASIC_INFORMATION64* lpBuffer, SIZE_T dwLength);
	__declspec(dllexport)DWORD64 __cdecl VirtualAllocEx64(HANDLE hProcess, DWORD64 lpAddress, SIZE_T dwSize, DWORD flAllocationType, DWORD flProtect);
	__declspec(dllexport)BOOL __cdecl VirtualFreeEx64(HANDLE hProcess, DWORD64 lpAddress, SIZE_T dwSize, DWORD dwFreeType);
	__declspec(dllexport)BOOL __cdecl VirtualProtectEx64(HANDLE hProcess, DWORD64 lpAddress, SIZE_T dwSize, DWORD flNewProtect, DWORD* lpflOldProtect);
	__declspec(dllexport)BOOL __cdecl ReadProcessMemory64(HANDLE hProcess, DWORD64 lpBaseAddress, LPVOID lpBuffer, SIZE_T nSize, SIZE_T *lpNumberOfBytesRead);
	__declspec(dllexport)BOOL __cdecl WriteProcessMemory64(HANDLE hProcess, DWORD64 lpBaseAddress, LPCVOID lpBuffer, SIZE_T nSize, SIZE_T *lpNumberOfBytesWritten);
	__declspec(dllexport)BOOL __cdecl GetThreadContext64(HANDLE hThread, _CONTEXT64* lpContext);
	__declspec(dllexport)BOOL __cdecl SetThreadContext64(HANDLE hThread, const _CONTEXT64* lpContext);
	__declspec(dllexport)VOID __cdecl SetLastErrorFromX64Call(DWORD64 status);
}
